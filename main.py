...
player_pergame = pd.read_csv("NBA_Data/Player Per Game.csv")
player_allstar = pd.read_csv("NBA_Data/All-Star Selections.csv")
player_awards = pd.read_csv("NBA_Data/Player Award Shares.csv")
team_stats = pd.read_csv("NBA_Data/Team Summaries.csv")
advanced_stats = pd.read_csv("NBA_Data/Advanced.csv")
...
# Removing all data prior to 1980. The NBA has changed drastically since its orgin and this will remove less relevant
# data from before the NBA-ABA merger and the three point line.
...
# datasets (this is due to players playing for multiple teams in one season).
